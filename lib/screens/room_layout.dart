...
class _RoomLayoutState extends State<RoomLayout> {
  ...
  showSnackBar(BuildContext context) {
    var snackbar =SnackBar(content: Text("Added to favorites!"),);
            ...
            children: [
              SizedBox(height: 10,),
                Padding(
                  ...
                  child: InkWell(onTap: () {
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 20,),
                        Text("Add to frequently used", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300), ),
                      ],
                    ),
                  ),
                  ),
                  ...
                  child: InkWell(onTap: () {},child: Container(
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 20,),
                        Text("Schedule", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300), ),
                      ],
                    ),
                  ),
                  ),
                  ...
                  child: InkWell(onTap: () {},child: Container(
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 20,),
                        Text("Add to mood", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300), ),
                      ],
                    ),
                  ),
                  ),
                  ...
                  padding: const EdgeInsets.symmetric(horizontal: 20,vertical: 10),
                  child: Ink(
                    child: InkWell(splashColor: Colors.grey,onTap: () {},child: Container(
                      child: Row(
                        children: [
                          Icon(Icons.timer,),
                          SizedBox(width: 20,),
                          Text("Set Timer", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w300), ),
                        ],
                      ),
                    ),
                    ),
